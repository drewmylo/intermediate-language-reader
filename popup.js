...
getNewVocab.onclick = function (element) {
  chrome.tabs.executeScript({
    ...
    res.forEach(element => {
      ...
      if (!(mostCommonWords.includes(element))) {
    ...
    chrome.tabs.executeScript({
      ...
      \`<!-- The Modal --> <div id="myModal" class="modal"> <!-- Modal content --> <div class="modal-content"> <span class="close">&times;</span> <textarea name="message" rows="10" cols="30">
      ${uncommonWords}
      </textarea>
